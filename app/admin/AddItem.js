...
export default function AddItem() {
  ...
  return (
    <>
      <div className="">
        <h1 className="text-center text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-black uppercase mb-4">
          Add new Menu Items
        </h1>
        <div className="flex flex-col items-center px-6">
          <div className="flex flex-wrap justify-center mb-6 gap-2 sm:gap-4">
            ...
            <button
              className={`p-2 text-sm sm:text-base md:text-lg font-semibold uppercase rounded text-white ${
                category === "Förätter" ? "bg-gray-400" : "bg-black"
              }`}
            ...
            <button
              className={`p-2 text-sm sm:text-base md:text-lg font-semibold uppercase rounded text-white ${
                category === "Varmrätter" ? "bg-gray-400" : "bg-black"
              }`}
            ...
            <button
              className={`p-2 text-sm sm:text-base md:text-lg font-semibold uppercase rounded text-white ${
                category === "Sallad" ? "bg-gray-400" : "bg-black"
              }`}
            ...
            <button
              className={`p-2 text-sm sm:text-base md:text-lg font-semibold uppercase rounded text-white ${
                category === "Popular Burgers" ? "bg-gray-400" : "bg-black"
              }`}
            ...
            <button
              className={`p-2 text-sm sm:text-base md:text-lg font-semibold uppercase rounded text-white ${
                category === "Deserts" ? "bg-gray-400" : "bg-black"
              }`}
            ...
            <button
              className={`p-2 text-sm sm:text-base md:text-lg font-semibold uppercase rounded text-white ${
                category === "Drinks" ? "bg-gray-400" : "bg-black"
              }`}
          ...
          >
            ...
            >
              Add to {category}{" "}
              {/* Changed button text to reflect the category */}
            </button>
          </form>
        </div>
      </div>
